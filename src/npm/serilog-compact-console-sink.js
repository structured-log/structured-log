...
function SerilogCompactJsonConsoleSink(options) {
  var self = this;
  options = options || {};

  self.emit = function(evts) {
    evts.forEach(function (evt) {
      var outputObject = evt.properties;
...
module.exports = function(options) { return new SerilogCompactJsonConsoleSink(options); };
